...
def calculate_dog_years():
    # Your control flow logic goes here
    dog_age = int(input('input the dog age: '))
    ...
    print(f'the dog age in dog years is {dog_years}')
# Call the function
calculate_dog_years()
...
def weather_advice():
    # Your control flow logic goes here
    is_cold = input('is it cold? Please enter yes or no: ')
    is_raining = input('is it raining? Please enter yes or no: ')
...
def determine_season():
    ...
    elif month in ('Apr', 'May'): season = 'Spring'
    elif month in ('Jul', 'Aug'): season = 'Summer'
    elif month in ('Oct', 'Nov'): season = 'Fall'
